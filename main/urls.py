...
urlpatterns = [
                  ...
                  path('help_request_list/<int:pk>/donate_financial/', views.donate_user, name='Financial_Donate'),
                  path('help_request_list/success_page/', views.donate_success, name='Success_Donate'),
